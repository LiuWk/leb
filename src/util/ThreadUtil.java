...
public class ThreadUtil extends ThreadPoolExecutor {
    ...
    private static final HashMap<String, ExecutorService> EXECUTOR_SERVICE_MAP = new HashMap<>();
    ...
    public static ExecutorService newCachedThreadPool(String poolName) {
        return new ThreadUtil(0, Integer.MAX_VALUE, 60L, TimeUnit.SECONDS, new SynchronousQueue<Runnable>(), poolName);
    }
