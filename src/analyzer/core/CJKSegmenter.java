...
import analyzer.dic.Dictionary;
import analyzer.dic.Hit;
...
class CJKSegmenter implements ISegmenter {
    ...
    public void analyze(AnalyzeContext context) {
        ...
        if (!this.tmpHits.isEmpty()) {
            ...
            for (Hit hit : tmpArray) {
                ...
                if (hit.isMatch()) {
                    ...
                    //List<Integer> corpusTypes = hit.getMatchedDictSegment().getLastType(context.getAvailable() - context.getCursor());
                    List<Integer> corpusTypes = hit.getCorpusTypes();
        ...
        if (singleCharHit.isMatch()) {//首字成词
            ...
            //List<Integer> corpusTypes = singleCharHit.getMatchedDictSegment().getLastType(context.getAvailable() - context.getCursor());
            List<Integer> corpusTypes = singleCharHit.getCorpusTypes();
            newLexeme.setCorpusTypes(corpusTypes);
            context.addLexeme(newLexeme);
